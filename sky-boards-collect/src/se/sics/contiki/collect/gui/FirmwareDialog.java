...
public class FirmwareDialog extends javax.swing.JDialog 
	...
	public FirmwareDialog(final JFrame parent, final String title,final String[] 
	                      moteList, final String[] firmwares) {
		...
		try {
	    	...
	    	infoColPane.setText("<html><strong>(Reference, Device, Description)</strong></html>");
	    	...
	    	for(final String elem: moteList) {
				...
				final ComboBoxModel jComboBox1Model = 
					new DefaultComboBoxModel(firmwares);
