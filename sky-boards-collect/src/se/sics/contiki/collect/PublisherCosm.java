...
public class PublisherCosm extends Thread{
	...
	public PublisherCosm(Hashtable<String,String> feedTable, String key, String cosmFeed){
		APIkey=key;
	...
	public void run() {
		if (feedTable.isEmpty()) return; //nothing to feed
		if (cosmTitle==null) return; // Title can't be blank
		if (cosmFeed==null) return;
