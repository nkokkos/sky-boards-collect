...
public class NodeCM5000 extends Node implements SensorInfo{
	
	public NodeCM5000(String nodeID) {
		super(nodeID);
		addNodeSensors();
	}


	public NodeCM5000(String nodeID, String nodeName) {
		super(nodeID, nodeName);
	}
	
	public void addNodeSensors(){
		sensors.put(LIGHT1, new NodeSensor("Light1", 
				LIGHT1,this.getID()));
		sensors.put(LIGHT2, new NodeSensor("Light2", 
				LIGHT2,this.getID()));
		sensors.put(TEMPERATURE, new NodeSensor("Temperature", 
				TEMPERATURE,this.getID()));
		sensors.put(HUMIDITY, new NodeSensor("Humidity", 
				HUMIDITY,this.getID()));
		setDefaultValues();
	}
